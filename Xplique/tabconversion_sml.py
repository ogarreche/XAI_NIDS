...
data = pd.read_csv ('sensor_db/dos-03-15-2022-15-44-32.csv', usecols=req_cols, low_memory=False, engine='c',
...
error = 'abs'
result_dir = '../Results/Table_To_Image_Conve_Sml_dos/Test_1'
...
result_dir = '../Results/Table_To_Image_Conve_Sml_dos/Test_2'
os.makedirs(name=result_dir, exist_ok=True)
table_to_image(norm_data, [num_row, num_col], fea_dist_method, image_dist_method, save_image_size,
               max_step, val_step, result_dir, error)